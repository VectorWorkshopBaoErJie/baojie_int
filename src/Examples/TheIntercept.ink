...
=== N开始 ===
	...
	- 	“这真是一个棘手的情况，” {T举起杯子:他|哈里斯}{V强势 <= 0:严厉起来|看着我}。我之前见过他用这种生硬的语气说话，但只有在跟高层说话时才这样。“我相信你会同意的。”
			* 	[表示同意] 
					“真尴尬，”我回答道
			* 	(T否认) [表示否认] 
					“我不明白为什么，”我回答道
...
=== N这里是布莱切利分厂
	“在布莱切利这里？当然。”
 	~ raise(V逃避)
 	~ lower(V强势)
	“在这里，现在，”哈里斯纠正道，“我们不是在跟所有人谈话。我能想象的出，你可能会对此感到非常不满，可能会觉得自己被针对了。 { V强势 < 0:“你是个敏感的人。”}"
	...
	*	{V强势 < 0}	“你这话是什么意思？”
 	...
 	* (T真实) { V强势 >= 0 } “该死的，你说得对。”[]我很不满。是其他人让你这么做的吗？是胡珀吗？他一直嫉妒我。他......”
		...
		很难不让人产生这样的感觉，他就是在{ V逃避 > 1 :嘲笑|逗}我。
		很难不去怀疑，他只是在{V逃避 > 1 :蔑视|敷衍}我。
		“还是嫉妒你的脑子？还是别的什么？”
 		* * 	“嫉妒我是天才。”[]胡珀就是受不了我比他聪明。我们整天都挤在那个营房里一起工作。这让他心烦意乱，甚至更糟。
...
=== N哈里斯要求组件 ===
	...
	- 	"正山小种," 他{N喝杯子中的茶:说道|回答}, 把自己的茶杯放回桌上，没有喝。“真是奇特的口味。这可能根本就不是茶。可以说它掩盖了许多罪恶。就像你一样。不是吗？”
		...
		* (T没什么不好意思的) { not V被投毒  }   [完全否认]
		 ...
		 * { not V被投毒  }   [回避] 
		 		“我们谁都有错，哈里斯。 { V强势 > 1:但你不是我的牧师，我也不是你的|但我没做过任何值得这样对待的事}。求你了，现在让我走吧。当然，我会帮你找到那个该死的元件。”
				//   你怪谁？
				他似乎正在考虑这个提议。
				 -> N哈里斯要求理论
...
=== N承认某事
	...
	“你想解释一下吗？”
		 ...
		 * (T什么也不说) { V被投毒  }   [闭口]
			...
			我肯定出了问题。我的舌头上有一种奇怪而苦涩的味道。当我开始说话时，我能体会到意识深处的这种味道。
		 	-> T我做了一些事情

	= T我知道在哪里
		“我知道元件在哪里，因为它的位置很明显。但并不能表示是我拿了它，仅仅因为我能解决一个简单的问题，并不意味着我就是敌国的间谍，因为我能破解他们的密码。”
		-> N哈里斯要求理论
...
=== N哈里斯要求理论
 	...
 	* [责怪某人] -> N要求胡珀接受组件
	= T一次事故
		“自然是意外。”我勉强挤出一个微笑，“那台该死的机器是用零件和电线拼凑起来的。就连这些小屋下雨时都会漏水。只要有人绊到电缆，部件就会掉下来。你们试过在机器下面找找吗？”
		“你以为我们没有试过吗？”
		我突然意识到他的回答是一种威胁。
		...
		* {V逃避 > 0} [回避] “只是觉得你不可理喻，表现得像头猪。”
			// 发脾气
			“你这个白痴，”哈里斯突然用力地回答道，他从椅子上半站了起来，“你和我一样清楚现在的形势。为什么还要装腔作势？那些敌人就像老鼠一样蓄势待发，准备席卷整个国家。他们会摧毁一切。我想你明白这一点，你难道只是沉迷于你的填字游戏，而看不到这些？我们这里的这台机器——你们这些人——是这个国家最好也是唯一的希望。”
				~ V失去理智  = true
...
=== N哈里斯以前也见过
	 ...
	 * [否认] 
		“我还是能解决这个问题的。”
		哈里斯摇了摇头。“你什么也做不了。这已经超出了你的能力范围。你可能会进监狱，也可能会被枪决——或者我们可以给你改个名字，把你送到一个因为轻率而不会伤害到你的地方。但现在，这些都不重要。你的下场不重要。重要的是那个部件在哪里。”
